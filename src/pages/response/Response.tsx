...
const Response = () => {
  ...
  return !loading ?(
    <div className='flex justify-center flex-col items-center h-screen gap-5 text-center'>
        ...
        <span className='text-2xl w-[700px]'>Your Appointment has been Booked with Appointment ID <span className='font-semibold'>{JSON.parse(response).id}</span> and Recommend OPD is <span className='font-semibold'>{JSON.parse(response).RecommendedOPD}</span></span>
